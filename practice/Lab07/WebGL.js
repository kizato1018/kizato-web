...
async function main(){
    ...
    //F: Face, T: Triangle
    cubeVertices = [//F1_T1_X,  F1_T1_Y,  F1_T1_Z,  F1_T2_X,  F1_T2_Y,  F1_T2_Z,   //this row for the face z = 1.0     
...
function draw(){
    ...
    mdlMatrix.translate(-0.5, 7.5, -0.5);
    mdlMatrix.scale(0.005, 0.1, 0.005);
    drawOneObject(mario, mdlMatrix, 0.4, 1.0, 0.4);

    //sonic
    //TODO-3: set mdlMatrix for sonic (include rotation and movement)
    mdlMatrix.translate(100, -65, 100);
    mdlMatrix.scale(100, 100, 100);
    mdlMatrix.translate(moveDistance, 0, 0);
